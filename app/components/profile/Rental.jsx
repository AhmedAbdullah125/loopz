                    ...
                    <div className="edit-profile-cont profile-order ">
                        ...
                        <div className="profile-r-side">
                            ...
                            <div className="tab-content-tickets">
                                ...
                                <div className="ticket-cont ticket-cont-list">
                                    <div className="l-side">
                                        <div className="img-cont-small img-cont-small-order">
                                            <Image src={data.product.image} width={100} height={100} alt="Loops" className="img-of-ticket" />
                                        </div>
                                        <div className="text-cont">
                                            <h3>{data.product.name}</h3>
                                            <h5><span className="heavy">{data.product.price} K.D</span></h5>
                                            <h4>Qnt : <span className="heavy">{data.quantity}</span></h4>
                                            <h6>Period : {data.date_from} - {data.date_to}</h6>
                                        </div>
                                    </div>
